<?php
  ...
  if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($surname_err) && empty($firstname_err) && empty($other_name_err) && empty($phone_err) && empty($dob_err)
     && empty($gender_err) && empty($marital_status_err) && empty($education_err) && empty($occupation_err)
     && empty($employment_err) && empty($dept_err) && empty($baptism_err)  && empty($tither_err) && empty($residence_error)
      && empty($email_err)){
    $sql = "INSERT INTO members (surname, firstname, other_name, dob, gender, marital_status,
      education, occupation, employment, phone, residence, dept, baptism, tither, email)
      VALUES (:surname, :firstname, :other_name, :dob, :gender, :marital_status, :education,
        :occupation, :employment, :phone, :residence, :dept, :baptism, :tither, :email)";
